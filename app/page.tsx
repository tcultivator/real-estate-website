            ...
            <div className="hero relative aspect-video w-full overflow-hidden">
              ...
              <div className="hero-text absolute inset-0 flex items-center justify-center flex-col text-white">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <button className="line line-3 text-white bg-white/20 backdrop-blur-sm hover:bg-white/30 hover:border-white/40 hover:text-white/80 border border-white/30 px-10 py-4 cursor-pointer flex items-center justify-center rounded-[25px] ">
                    CALL NOW
                  </button>
